                    ...
                    <div class="card-body">
                            ...
                            <div class="col-12 col-sm-7">
                                <div class="row">
                                    <div class="col-4 col-md-4">
                                        <img class="customer-img" src="{{asset('admin-assets')}}//images/faces/face22.jpg"
                                            alt="" />
                                    </div>
                            ...
                            <div class="col-sm-7">
                                <div class="row">
                                    <div class="col-4 col-sm-4">
                                        <img class="customer-img" src="{{asset('admin-assets')}}//images/faces/face25.jpg"
                                            alt="" />
                                    </div>
                        ...
                        <div class="row py-1">
                            <div class="col-sm-7">
                                <div class="row">
                                    <div class="col-4 col-sm-4">
                                        <img class="customer-img" src="{{asset('admin-assets')}}//images/faces/face15.jpg"
                                            alt="" />
                                    </div>
                                    <div class="col-8 col-sm-8 p-sm-0">
                        ...
                        <div class="row py-1">
                            <div class="col-sm-7">
                                <div class="row">
                                    <div class="col-4 col-sm-4">
                                        <img class="customer-img" src="{{asset('admin-assets')}}//images/faces/face5.jpg"
                                            alt="" />
                                    </div>
                                    <div class="col-8 col-sm-8 p-sm-0">
                        ...
                        <div class="row">
                            <div class="col-sm-7">
                                <div class="row">
                                    <div class="col-4 col-sm-4">
                                        <img class="customer-img" src="{{asset('admin-assets')}}//images/faces/face2.jpg"
                                            alt="" />
                                    </div>
                                    <div class="col-8 col-sm-8 p-sm-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                            <div class="col-sm-9 pl-0">
                                <div class="d-flex">
                                    <img src="{{asset('admin-assets')}}//images/dashboard/img_4.jpg" alt="" />
                                    <div class="pl-2">
                        ...
                        <div class="row mt-5">
                            <div class="col-sm-12">
                                <ul class="d-flex pl-0 overflow-auto">
                                    ...
                                    <li
                                        class="weakly-weather-item text-white font-weight-medium text-center">
                                        <p class="mb-0">MON</p>
                                ...
                                <p class="text-muted">
                                    ...
                                    <span class="d-inline-block">
                                        <span class="d-flex d-inline-block">
                                            <img class="ml-1" src="{{asset('admin-assets')}}//images/faces/face1.jpg"
                                                alt="" />
                                            <img class="ml-1" src="{{asset('admin-assets')}}//images/faces/face10.jpg"
                                                alt="" />
                                            <img class="ml-1" src="{{asset('admin-assets')}}//images/faces/face14.jpg"
                                                alt="" />
                                        </span>
                                    </span>
                                </p>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-5 col-sm-4">
                                    <div class="d-flex pt-1 align-items-center">
                                        ...
                                        <div class="dropdown dropleft pl-1 pt-3">
                                            <div id="dropdownMenuButton3" data-toggle="dropdown"
                                                role="button" aria-haspopup="true"
                                                aria-expanded="false">
                                                <p><i class="mdi mdi-dots-vertical"></i></p>
                                            </div>
                        ...
                        <div class="list-card">
                            <div class="row align-items-center">
                                <div class="col-7 col-sm-8">
                                    <div class="row align-items-center">
                                        <div class="col-sm-4">
                                            <img src="{{asset('admin-assets')}}//images/faces/face11.jpg" alt="" />
                                        </div>
                                        <div class="col-sm-8 pr-0 pl-sm-0">
                                ...
                                <div class="col-5 col-sm-4">
                                    <div class="d-flex pt-1 align-items-center">
                                        ...
                                        <div class="dropdown dropleft pl-1 pt-3">
                                            <div id="dropdownMenuButton4" data-toggle="dropdown"
                                                role="button" aria-haspopup="true"
                                                aria-expanded="false">
                                                <p><i class="mdi mdi-dots-vertical"></i></p>
                                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-5 col-sm-4">
                                    <div class="d-flex pt-1 align-items-center">
                                        ...
                                        <div class="dropdown dropleft pl-1 pt-3">
                                            <div id="dropdownMenuButton5" data-toggle="dropdown"
                                                role="button" aria-haspopup="true"
                                                aria-expanded="false">
                                                <p><i class="mdi mdi-dots-vertical"></i></p>
                                            </div>
