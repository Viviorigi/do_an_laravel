                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" placeholder="Điền địa chỉ" class="checkout__input__add">
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text"
                                    placeholder="Điền bạn có yêu cầu gì thêm với shop">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <div class="checkout__order__total">Tổng số tiền <span>$750.99</span></div>
